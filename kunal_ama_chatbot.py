...
# Intro
st.write("""
Welcome! This is an interactive chatbot to help you learn about Kunal's background, expertise, and vision for AI at VSP Vision's Innovation Center. 
...
if user_question:
    ...
    best_match = find_best_match(user_question, qa_pairs.keys())
    
    # Now we'll always use GPT-4 with the resume context
